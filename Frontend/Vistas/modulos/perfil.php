                                ...
                                echo '<li class="col-md-3 col-sm-6 col-xs-12">
                                            ...
                                            if($value2["oferta"] != 0){
                                                ...
                                                echo '<h2>
                                                        ...
                                                        <small>
                                                            ...
                                                            <strong class="oferta">USD $'.$value2["precio"].'</strong>
                                                ...
                                                echo '<h2><small>USD $'.$value2["precio"].'</small></h2>';
                                        ...
                                        <div class="col-xs-6 enlaces">
                                            ...
                                            <div class="btn-group pull-right">
                                                ...
                                                <button type="button" class="btn btn-danger btn-xs quitarDeseo" idDeseo="'.$value["id"].'" data-toggle="tooltip" title="Quitar de mi lista de deseos">
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12 text-center">
                            ...
                            <figure id="imgPerfil">
                                <?php
                                    ...
                                    echo'<input type="hidden" id="passUsuario" name="passUsuario" value="'.$_SESSION["password"].'">';
                                    echo'<input type="hidden" id="fotoUsuario" name="fotoUsuario" value="'.$_SESSION["foto"].'">';
                                    echo'<input type="hidden" id="modoUsuario" name="modoUsuario" value="'.$_SESSION["modo"].'">';
        ...
        <div class="modal-body modalTitulo">
            ...
            <form method="post" onsubmit="return validarComentario()">
                ...
                <h1 class="text-center" id="estrellas">
                    <i class="fa fa-star text-success" arial-hidden="true"></i>
                    <i class="fa fa-star text-success" arial-hidden="true"></i>
                    <i class="fa fa-star text-success" arial-hidden="true"></i>
                    <i class="fa fa-star text-success" arial-hidden="true"></i>
                    <i class="fa fa-star text-success" arial-hidden="true"></i>
                ...
                <div class="form-group">
                    <label for="coment" class="text-muted">Tu opinión acerca de este producto de este producto: <span><small>(máximo 300 caracteres)</small></span></label>
                    <textarea name="comentario" id="comentario" maxlength="300" rows="5" class="form-control" required></textarea>
                    <br>
