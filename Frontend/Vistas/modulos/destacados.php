...
<?php
    ...
    if($titulosModulos[0]=="ARTÍCULOS GRATUITOS"){
        ...
        $valor = "valor";
        $modo = "DESC";
        $gratis = ControladorProductos::ctrMostarProductos($ordenar,$item,$valor,$base,$tope,$modo);
    }
    if($titulosModulos[1]=="LO MÁS VENDIDO"){
        ...
        $valor = null;
        $modo = "DESC";
        $ventas = ControladorProductos::ctrMostarProductos($ordenar,$item,$valor,$base,$tope,$modo);
    }
    if($titulosModulos[2]=="LO MÁS VISTO"){
        ...
        $valor = null;
        $modo = "DESC";
        $vistas = ControladorProductos::ctrMostarProductos($ordenar,$item,$valor,$base,$tope,$modo);
    }
