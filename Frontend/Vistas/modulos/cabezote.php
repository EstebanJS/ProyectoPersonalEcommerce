<?php
	...
	/*============================================================
		RECIBE VARIABLE CODE DE GOOGLE
	============================================================*/
	if(isset($_GET["code"])){
...
TOP
======================================-->
<div class="container-fluit barraSuperior" id="top">
	<div class="container">
		<div class="row">
			<!--=====================================
			SOCIAL
					...
					if(isset($_SESSION["validarSesion"])){
						if($_SESSION["validarSesion"]== "ok"){
							if($_SESSION["modo"] == "directo"){
								if($_SESSION["foto"] != ""){
									echo'
										<li><img src="'.$url.$_SESSION["foto"].'" width="10%" class="img-circle"></li>
									';
								}
								else{
									echo'
										<li><img src="'.$servidor.'Vistas/img/usuarios/default/anonymous.png" width="10%" class="img-circle"></li>
									';
								}
								echo'<li>|</li>
						 	...
						 	if($_SESSION["modo"] == "facebook"){
								echo'
									<li><img src="'.$_SESSION["foto"].'" width="10%" class="img-circle"></li>									
								';
								echo'<li>|</li>
								<li><a href="'.$url.'perfil"> Ver perfil</a></li>
								<li>|</li>
				...
				foreach ($categorias as $key => $value) {
					...
					<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
						...
						foreach ($subcategorias as $key => $value) {
							echo '<li><a href="'.$url.$value["ruta"].'/1" class="pixelSubCategorias">'.$value["subcategoria"].'</a></li>';
						}
					echo'	
						</ul>
					</div>
...
<div class="modal fade modalFormulario" id="modalRegistro" role="dialog">
    <div class=" modal-content modal-dialog">
        ...
        <div class="modal-footer">
          ¿Ya tienes una cuenta registrad? | <strong><a href="#modalIngreso" data-dismiss="modal" data-toggle="modal">Ingresar</a></strong>
        </div>
      </div>
</div>
<!--=====================================
    ...
    <div class=" modal-content modal-dialog">
        <div class="modal-body modalTitulo">
			...
			<form method="post" >
				...
				<?php
					$regitro = new ControladorUsuarios();
					$regitro -> ctrRegistroUsuario();
				?>
        ...
        <div class="modal-footer">
          ¿No tienes una cuenta registrada? | <strong><a href="#modalRegistro" data-dismiss="modal" data-toggle="modal">Registra</a></strong>
        </div>
      </div>
</div>
...
<div class="modal fade modalFormulario" id="modalPassword" role="dialog">
    <div class=" modal-content modal-dialog">
        <div class="modal-body modalTitulo">
			...
			======================================-->
			<form method="post" >
			<label for="passEmail" class="text-muted">Escribe el correo electrónico con el questas registrado:</label>
				<div class="form-group">
					<div class="input-group">
						<span class="input-group-addon">
							<i class="glyphicon glyphicon-envelope"></i>
