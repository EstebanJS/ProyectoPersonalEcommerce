...
BARRA PRODUCTOS
======================================-->
<div class="container-fluit well well-sm barraProductos">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            ...
            if(isset( $rutas[3])){
                ...
                if (!$productos) {
                    echo '<div class="col-xs-12 error404 text-center"><h1><small>!Oops¡</small></h1><h2>Aún no hay productos en esta sección</h2></div>';
                }
                else{
                    echo '<ul class="grid0">';
                ...
                if(count($listaProductos)!=0){
                    ...
                    if($pagProductos >4){
                        ...
                        if($rutas[1] == 1){
                            ...
                            <li><a href="'.$url.$rutas[0].'/2'.'/'.$rutas[2].'/'.$rutas[3].'"><i class="fa fa-angle-right" arial-hidden="true"></i></a></li>
                            </ul>
                            ';
                        }
                        /*-=====================================
                        LOS BOTONES DE LA MITAD HACIA ABAJO
                        ======================================-->*/
                        else if($rutas[1] != $pagProductos && $rutas[1] != 1 && $rutas[1] < ($pagProductos/2) && $rutas[1] < ($pagProductos-3)){
                            $numPagActual = $rutas[1];
                            echo '
                            <ul class="pagination">
                            <li><a href="'.$url.$rutas[0].'/'.($numPagActual-1).'/'.$rutas[2].'/'.$rutas[3].'"><i class="fa fa-angle-left" arial-hidden="true"></i></a></li>
                            ...
                            <li><a class="disabled">...</a></li>
                            <li id="item'.$pagProductos.'"><a href="'.$url.$rutas[0].'/'.$pagProductos.'/'.$rutas[2].'/'.$rutas[3].'">'.$pagProductos.'</a></li>
                            <li><a href="'.$url.$rutas[0].'/'.($numPagActual+1).'"><i class="fa fa-angle-right" arial-hidden="true"></i></a></li>
                            </ul>
                            ';
                        }
                        /*-=====================================
                        LOS BOTONES DE LA MITAD HACIA ARRIBA
                        ======================================-->*/
                        else if($rutas[1] != $pagProductos && $rutas[1] != 1 && $rutas[1] >= ($pagProductos/2) && $rutas[1] < ($pagProductos-3)){
                            $numPagActual = $rutas[1];
                            echo '
                            ...
                            echo '
                                <li><a href="'.$url.$rutas[0].'/'.($numPagActual+1).'/'.$rutas[2].'/'.$rutas[3].'"><i class="fa fa-angle-right" arial-hidden="true"></i></a></li>
                                </ul>
                            ';
                        }
                        /*-=====================================
                        LOS BOTONES DE LAS ULTIMAS 4 PAGINAS Y LA ULTIMA PAGINA
                        ======================================-->*/
                        else{
                            $numPagActual = $rutas[1];
                            echo '
