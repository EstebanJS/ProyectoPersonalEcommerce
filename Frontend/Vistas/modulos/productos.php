    ...
    <div class="container">
        <div class="row">
            ...
            if($rutas[0] == "articulos-gratis"){
                ...
                $productos = ControladorProductos::ctrMostarProductos($ordenar,$item2,$valor2,$base,$tope,$modo);
                ...
                if(count($listaProductos)!=0){
                    ...
                    if($pagProductos >4){
                        ...
                        if($rutas[1] == 1){
                            ...
                            <li><a href="'.$url.$rutas[0].'/2"><i class="fa fa-angle-right" arial-hidden="true"></i></a></li>
                            </ul>
                            ';
                        }
                        /*-=====================================
                        ...
                        ======================================-->*/
                            ...
                            echo '
                            <ul class="pagination">
                            <li><a href="'.$url.$rutas[0].'/'.($numPagActual-1).'"><i class="fa fa-angle-left" arial-hidden="true"></i></a></li>
