<?php
    class ControladorProductos{
        ...
        MOSTRAR PRODUCTOS
        =============================================*/
        static public function ctrMostarProductos($ordenar,$item,$valor,$base,$tope,$modo){
            $tabla = "productos";
            $respuesta = ModeloProductos::mdlMostarProductos($tabla,$ordenar,$item,$valor,$base,$tope,$modo);
            return $respuesta;
        }
        /*=============================================
        ...
        static public function ctrMostrarInfoProducto($item,$valor){
            $tabla = "productos";
            $respuesta = ModeloProductos::mdlMostarInfoProductos($tabla,$item,$valor);
            return $respuesta;
        }
        /*=============================================
        LISTAR PRODUCTOS
